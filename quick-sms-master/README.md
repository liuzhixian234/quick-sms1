...
## 项目说明
此项目为完全开源项目，您可以完全基于此开发您自己的商业项目。此项目仅仅是短信协议处理的中间件，如果您需要完整的短信解决方案，请参考我司开源的[短信平台单机版](https://gitee.com/er-jin-zhi/sms-platform-stand-alone)
...
6. 自动的连接重试机制
7. 丰富的自定义业务实现接口
使用此项目将极大简化您的协议开发流程，减少项目风险。此项目已经在我司开源的[短信平台单机版](https://gitee.com/er-jin-zhi/sms-platform-stand-alone)中应用，您可参考项目中的应用来实现自己的业务需求。
...
//        socketConfig.setSmsSignature("【二进制科技】");
        ...
        sessionManager.setMessageProvider(new MessageProvider() {
            ...
            public List<IMessage> getTcpMessages(ChannelSession channelSession) {
                ...
                String message = i + Math.random() + "第二次李白字太白，号青莲居士，【二进制】";
                ...
                requestMessage.setSignature("【二进制科技】");
                //收到响应的回调
...
```
#### 客户端短信测试软件
  为了方便大家对中间件的理解和应用，我们开源了一个短信测试软件，有需要的同学可以参考https://gitee.com/er-jin-zhi/client_tool
